...
xcodebuild \
  ...
  -scheme "Souzaiosoficial EXTERNAL" \
...
APP="$ARCHIVE/Products/Applications/Souzaiosoficial EXTERNAL.app"
test -d "$APP"
...
/usr/libexec/PlistBuddy -c "Set :CFBundleExecutable Souzaiosoficial EXTERNAL" "$APP/Info.plist" || true
